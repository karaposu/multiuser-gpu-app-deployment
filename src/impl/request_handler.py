...
from impl.services.image_manipulation import  DomImageManipulationService, ImageManipulationService, UsrImageManipulationService
from impl.services.increasing_limit import  IncreaseLimitService
from impl.services.register_new_user import  RegisterService
from impl.services.source_monitor import SourceMonitoringService
from impl.services.text_to_image import TextToImageService
...
class RequestHandler:
    ...
    def handle_dom_image_manipulation_request(self, request: MANDOMIMAGEPostRequest) -> DOMImageManipulationResponse:
        ...
        if not op_valid:
            ...
            p=DomImageManipulationService(request)
            images_data=p.response
            ops = OperationStatus(success="true", error_code="", debug_log="", package_sent_time="", counter=12)
